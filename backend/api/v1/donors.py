...
from schemas import DonorCreate, DonorUpdate, DonorResponse, TaskCreate, TaskResponse
...
async def create_donation_task(
    ...
    drop_location = create_point(task_data.drop_lat, task_data.drop_lng) if task_data.drop_lat and task_data.drop_lng else None
