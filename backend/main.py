...
# CORS middleware - allow all origins for dev (Flutter web runs on dynamic ports)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
if __name__ == "__main__":
    try:
        ...
        logger.info("📍 Environment: Production" if not settings.DEBUG else "📍 Environment: Development")
