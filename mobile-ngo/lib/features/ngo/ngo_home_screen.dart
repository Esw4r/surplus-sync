...
class _NgoHomeScreenState extends ConsumerState<NgoHomeScreen> {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _rejectionReason = ngoInfo['rejection_reason'];
        });
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_verificationStatus == 'PENDING' || _verificationStatus == 'REJECTED') {
      ...
      return Scaffold(
        appBar: AppBar(
          title: Text(_ngoName, overflow: TextOverflow.ellipsis),
          actions: [
            IconButton(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isRejected 
                      ? 'Your NGO application has been rejected by the administrator. Please update your details and resubmit.'
                ...
                if (isRejected)
                  ElevatedButton.icon(
                    ...
                    label: const Text('Update Registration Details'),
